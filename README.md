...
<table>
  <tr>
    <td width="50%">
      <h4>🐄 <a href="https://github.com/armanfatavat/PROJECT_LINK">Image-Based Breed Recognition</a></h4>
      Built a CNN-based animal breed classification system as Data Engineer for "Visionary Herd" (Smart India Hackathon 2025) — achieved ~95% accuracy after preprocessing and augmenting a multi-breed image dataset.
      <br/><br/>
      <code>Python</code> <code>CNN</code> <code>TensorFlow</code>
    </td>
    <td width="50%">
      <h4>📰 <a href="https://github.com/armanfatavat/PROJECT_LINK">Fake News Detection</a></h4>
      ML + NLP classification model to identify fake news articles (UNESCO Global Youth Hackathon 2025) — tokenization, stemming, and vectorization pipeline with a Flask web app for real-time predictions.
      <br/><br/>
      <code>Python</code> <code>NLP</code> <code>Flask</code>
    </td>
  </tr>
</table>
...
- Machine Learning — IBM via Coursera (2025)

---

### 🏆 Achievements

- 🌍 Participant — UNESCO Global Youth Hackathon 2025 (international social-impact project)
- 🇮🇳 Participant — Smart India Hackathon 2025, Data Engineer for "Visionary Herd"
